...
public class updatePatient extends javax.swing.JFrame {
   ...
   // int count;
    ...
    public void loadData() {
        ...
        String sql = "select Jdate,Hid,Fname,age,gender,address,phone,status,disease,room from patient";
        try {
...
//        int pcount = Integer.parseInt((pUTable.getValueAt(row, 0).toString()));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        //+ "' where count = '" + count + "'"
String sql = "Update patient set Jdate = '" + date + "', Hid = '" + id + "', Fname = '" + name + "', age = '" + age + "', gender = '" + gender + "', address = '" + address + "', phone = '" + phone + "', status = '" + status + "', disease = '" + disease + "', room = '" + room ;
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
