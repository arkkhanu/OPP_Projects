...
public class updateReceptionist extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        String sql = "select joining,id,name,age,gender,blood,email,phone,address,status,username,password from receptionist";
        try {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update receptionist set joining = '" + date + "', id = '" + id + "', name = '" + name + "', age = '" + age + "', gender = '" + gender + "', blood = '" + blood + "', email = '" + email + "', phone = '" + phone + "', address = '" + address + "', status = '" + Status + "', username = '" + username + "' where password = '" + password + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
