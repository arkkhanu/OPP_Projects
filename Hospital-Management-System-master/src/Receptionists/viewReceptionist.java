...
public class viewReceptionist extends javax.swing.JFrame {
    ...
    public final void loadData() {
        ...
        String sql = "select joining,Hid,Fname,age,gender,blood,email,phone,address,status,username from receptionist";
        try {
    ...
    private void rPassBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rPassBtnActionPerformed
        if (rPassBtn.isSelected()) {
            ...
            connection = Connector.ConnectDb();
            String sql = "select joining,Hid,Fname,age,gender,blood,email,phone,address,status,username,password from receptionist";
            try {
                ps = connection.prepareStatement(sql);
                rs = ps.executeQuery();
