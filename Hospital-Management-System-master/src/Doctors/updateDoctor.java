...
//Serial", 
    ...
    public void loadData() {
        ...
        String sql = "select Jdate,Hid,Fname,age,gender,blood,dept,phone,email,status,address,room,username,password from doc";
        try {
            ...
            //    columnData[0] = rs.getInt("count");
                columnData[1] = rs.getString("Jdate");
                columnData[2] = rs.getString("Hid");
    ...
    private void dUTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dUTableMouseClicked
        ...
        int col = dUTable.getSelectedColumn();
...
//      
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();//+ "' where count = '" + count + "'"
      //  String sql = "Update doc set Jdate = '" + date + "', Hid = '" + id + "', Fname = '" + name + "', age = '" + age + "', gender = '" + gender + "', blood = '" + blood + "', dept = '" + dept + "', phone = '" + phone + "', email = '" + email + "', status = '" + status + "', address = '" + address + "', room = '" + room + "', username = '" + username + " where password = '" + password +"'";
          String sql = "Update doc set Jdate = '" + date + "', Hid = '" + id + "', Fname = '" + name + "', age = '" + age + "', gender = '" + gender + "', blood = '" + blood + "', dept = '" + dept + "', phone = '" + phone + "', email = '" + email + "', status = '" + status + "', address = '" + address + "', room = '" + room + "', username = '" + username + " where password = '" + password+ "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
